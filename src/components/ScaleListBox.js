    ...
    <div className="w-[6.5rem] sm:mr-5 lg:mr-3 xl:mb-4">
      <Listbox
        ...
        <div className="relative mt-1">
          <Listbox.Button className="relative w-[95%] sm:w-full py-2 pl-3 pr-10 text-left text-xs sm:text-sm rounded-lg bg-zinc-100 border-2 border-zinc-400 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-opacity-75 focus-visible:ring-white focus-visible:ring-offset-orange-300 focus-visible:ring-offset-2 focus-visible:border-indigo-500">
